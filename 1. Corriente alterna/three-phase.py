...
ean = ax.plot(time[0], va[0], label="Ean", color="tab:blue")[0]
ebn = ax.plot(time[0], vb[0], label="Ebn", color="tab:orange")[0]
ecn = ax.plot(time[0], vc[0], label="Ecn", color="tab:purple")[0]
...
matplotlib.rcParams["animation.ffmpeg_path"] = "C:\\ffmpeg\\ffmpeg_essentials_build\\bin\\ffmpeg.exe"
writer = animation.FFMpegWriter(fps=100, metadata={"artist" : "Gomer"}, bitrate=15000)
ani.save("three-phase.mp4")
